...
AdsViewEditor.prototype.init = function(options, editor, targetingEditor, params, paramsData, paramsParams) {
  ...
  this.params = {
    ...
    disclaimer_finance:         {value: 0},
    disclaimer_finance_name:       {value: '', value_escaped: '', value_default: '', max_length: 0},
    disclaimer_finance_license_no: {value: '', value_escaped: '', value_default: '', max_length: 0},
