...
Ads.showRetargetingPriceListEditBox = function(event, unionId, hash, priceListId, priceListName, priceListUrl) {
  ...
  box.removeButtons();
  box.addButton(getLang('global_save'), function() { Ads.saveRetargetingPriceList(unionId, hash, priceListId, priceListName, priceListUrl) }, '', false, 'ads_retargeting_box_price_list_save');
